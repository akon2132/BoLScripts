...
local UPDATE_PATH = "/bolqqq/BoLScripts/master/Better%20Nerf%20Irelia.lua?chunk="..math.random(1, 1000)
...
function _Menu()
	menu = scriptConfig("Irelia: Main Menu", "Better Nerf Irelia")
		...
		--[Version, Author]--
		menu:addParam("Version", "Version", SCRIPT_PARAM_INFO, IreliaVersion)
